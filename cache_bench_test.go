...
type cacheFactory struct {
	name string
	make func(tb testing.TB, entrySize int, maxBytes int64) cacheStore
}

var cacheFactories = []cacheFactory{
	{"Map", func(tb testing.TB, es int, mb int64) cacheStore {
		switch es {
		case 4:
	...
	{"Page", func(tb testing.TB, es int, mb int64) cacheStore {
		return newPageCacheStore(es, mb)
	}},
	{"Mmap", func(tb testing.TB, es int, mb int64) cacheStore {
		cs, err := newMmapCacheStore(es, mb)
		if err != nil {
			tb.Fatal(err)
		}
		return cs
